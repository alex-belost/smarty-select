const SmartySelect = (() => {
  class $ {
    ...
    static polyfills() {
      try {
        ...
        window.CustomEvent = function (event, params) {
          ...
          evt.initCustomEvent(event, paramsConfig.bubbles, paramsConfig.cancelable, paramsConfig.detail);
          return evt;
        };
    ...
    createSelect() {
      ...
      configSelect.mainParent = $.el(this.initSelector);
      configSelect.mainSelect = $.el(`${this.initSelector} > select`);
      ...
      const { blockName, defaultClass } = $.config();
      ...
      $.each(configSelect.mainOptions, (mainOption, index) => {
